...
if __name__ == "__main__":
	...
	# print "Accuracy on regular data: ", ordinary_accuracy*100
	...
	print "Accuracy with linear SVM on mSDA features: ", deep_accuracy*100
	...
	print "Accuracy with linear SVM on mcf: ", mcf_accuracy*100
	'''
